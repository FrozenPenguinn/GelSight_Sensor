...
bg_img = cv2.imread("./img/set5/3.jpg")
raw_img = cv2.imread("./img/set5/6.jpg")
...
while key != 108: # l
    ...
    im2show = cv2.rectangle(np.array(raw_img),(center[0]-radius, center[1]-radius),(center[0]+radius, center[1]+radius),(0, 40, 0),2)
...
cv2.rectangle(contact_mask,(center[0]-radius, center[1]-radius),(center[0]+radius, center[1]+radius),(0, 40, 0),2)
'''
...
cv2.imwrite("./testing/bg_img.jpg", bg_img)
cv2.imwrite("./testing/raw_img.jpg", raw_img)
np.save("./testing/contact_mask.npy", contact_mask)
